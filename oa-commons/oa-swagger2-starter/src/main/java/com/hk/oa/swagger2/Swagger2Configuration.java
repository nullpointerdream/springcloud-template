 ...
 * Swagger2 启动类
 * 启动条件：
 * 1，配置文件中oa.swagger.enabled=true
 * 2，配置文件中不存在：oa.swagger.enabled 值
 *
 */
@Configuration
@ConditionalOnProperty(name = "oa.swagger.enabled", havingValue = "true", matchIfMissing = true)
@EnableSwagger2
...
public class Swagger2Configuration implements WebMvcConfigurer {
    ...
    public static class ZhSecurityConfiguration {
        ...
        @ConditionalOnProperty(name = "oa.swagger.production", havingValue = "true")
        ...
        @Bean
        @ConditionalOnMissingBean
        @ConditionalOnProperty(name = "oa.swagger.basic.enable", havingValue = "true")
        ...
        @ConditionalOnMissingBean
        @ConditionalOnProperty(name = "oa.swagger.markdown.enable", havingValue = "true")
