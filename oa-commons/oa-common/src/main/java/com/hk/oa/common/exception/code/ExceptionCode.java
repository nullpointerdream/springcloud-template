package com.hk.oa.common.exception.code;
...
public enum ExceptionCode implements BaseExceptionCode {
    ...
    JWT_TOKEN_EXPIRED(40001, "accessToken过期"),
    JWT_REFRESH_TOKEN_EXPIRED(40002, "登录超时,请重新登录"),
    JWT_SIGNATURE(40003, "不合法的token，请认真比对 token 的签名"),
    JWT_ILLEGAL_ARGUMENT(40004, "缺少token参数"),
    JWT_GEN_TOKEN_FAIL(40005, "生成token失败"),
    JWT_PARSER_TOKEN_FAIL(40006, "解析token失败"),
    JWT_USER_INVALID(40007, "用户名或密码错误"),
    JWT_USER_ENABLED(40008, "用户已经被禁用！"),
    //jwt token 相关 end
